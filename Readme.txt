How to run the Zoo Management System (ZMS) Project

1. Download the zip file

2. Extract the file and copy zoo folder

3.Paste inside root directory(for xampp xampp/htdocs, for wamp wamp/www, for lamp var/www/html)

4. Open PhpMyadmin (http://localhost/phpmyadmin)

5. Create a database with name zoo

6. Import zoo.sql file(given inside the zip package in SQL file folder)

7.Run the script http://localhost/zoo (frontend)
