                            ...
                            <div class="col-md-4 border-right">
                              <div class="d-flex flex-column align-items-center text-center p-3 py-5">
                               ...
                               if($row->Photo=="avatar15.jpg"){ ?>
                                <img class="rounded-circle " src="profileimages/avatar15.jpg"  width="90">
                                <?php 
                              } else { ?>
                                <img class="rounded-circle"  src="profileimages/<?php  echo $row->Photo;?>" width="120">
                                <?php 
                              } ?><span class="font-weight-bold"><?php  echo $row->FirstName;?> <?php  echo $row->LastName;?></span><span class="text-black-50"><?php  echo $row->Email;?></span><span><?php  echo $row->MobileNumber;?></span>
                              <div class="mt-3">
